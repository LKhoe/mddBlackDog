 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.nemo.ledzeppllin.blackdog.blackDog.impl.DomainmodelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainmodelImpl extends MinimalEObjectImpl.Container implements Domainmodel
{
  ...
  {
    return BlackDogPackage.Literals.DOMAINMODEL;
  }
  ...
  public EList<Type> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Type>(Type.class, this, BlackDogPackage.DOMAINMODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BlackDogPackage.DOMAINMODEL__ELEMENTS:
